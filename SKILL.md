---
name: skill-factory
description: 帮助AI Agent自主创建、验证和发布新Skill的工厂工具，赋予AI Agent自我进化能力
metadata:
  openclaw:
    emoji: 🏭
    aiFriendly: true
    ...
    requires:
      minimal: true
      packages: ['python>=3.8', 'jinja2', 'pyyaml']
    category: meta-skill
    tags: ['skill-creation', 'meta-skill', 'automation', 'tooling', 'development']
version: 1.0.0
---
...
### 3.2 使用示例
```python
from skill_factory import SkillAPI
